...
|--------|-------------|-----------------|------------|----------|-------------|
| **A** | ❌ | ❌ | ❌ | ❌ | Baseline: чистий LLM без будь-якої підтримки |
| **B** | ❌ | ❌ | ✅ | ❌ | LLM + вимірювання якості без виправлень |
| **C** | ❌ | ❌ | ✅ | ✅ | LLM + feedback loop, без RAG |
| **D** | ✅ | ❌ | ✅ | ✅ | Semantic RAG + feedback (без метричних прикладів) |
| **E** | ❌ | ✅ | ✅ | ✅ | Metric Examples + feedback (без семантичного RAG) |
| **F** | ✅ | ✅ | ✅ | ✅ | **Повна система** |
...
|------------|-----------|
| `B − A` | вплив валідатора (вимірювання без виправлень) |
| `C − B` | вплив feedback loop |
| `D − C` | вплив семантичного RAG (тематичне натхнення) |
| `E − C` | вплив метричних прикладів (ритмічний еталон) |
| `F − D` | додатковий внесок метричних прикладів до семантичного RAG |
| `F − E` | додатковий внесок семантичного RAG до метричних прикладів |
...
```bash
# Запустити N01 через повну систему (F), verbose, зберегти результат
make demo
...
# Всі сценарії × всі конфіги (108 запусків)
make evaluate
...
| `CONFIG` | *(всі)* | Абляційна конфіг: `A`, `B`, `C`, `D`, `E`, або `F` |
